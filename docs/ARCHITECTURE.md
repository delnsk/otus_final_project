...
| --- | --- | --- |
| 4 MCP-инструмента с богатым `description` и описаниями параметров (`Annotated`) | задание | Тонкий MCP-слой над сервисами приложения |
...
│  │  ├─ tools.py                # 4 инструмента: description + Annotated-параметры
